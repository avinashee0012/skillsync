...
public class AdminController {
    ...
    public AdminController(UserServiceImpl userServiceImpl, ModelMapper modelMapper) {
        this.userServiceImpl = userServiceImpl;
        this.modelMapper = modelMapper;
    }
    
    @GetMapping("/dashboard")
    public ModelAndView getAdminDashboard(@AuthenticationPrincipal UserDetails userDetails, ModelAndView modelAndView) {
